...
// Tipo para un piloto (ajústalo según la estructura real de tu API)
interface Piloto {
  driverId: string;
  [key: string]: any; // Puedes reemplazar esto con campos específicos si lo prefieres
}

function MainPilotos(): JSX.Element {
